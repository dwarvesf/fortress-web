...
import { EmployeePeerReviewStatus, SurveyEventStatus } from 'constants/status'
...
export interface MemberPeerReviewDetail {
  ...
  status?: EmployeePeerReviewStatus
}

export const employees: ViewEmployeeData[] = [
  {
